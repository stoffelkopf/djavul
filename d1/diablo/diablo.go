...
func loadLevelGraphics() {
	...
	case gendung.Tristram:
		*gendung.LevelCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\TownData\Town.CEL`)), nil))
		...
		*gendung.LevelSpecialCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\TownData\TownS.CEL`)), nil))
	case gendung.Cathedral:
		*gendung.LevelCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L1Data\L1.CEL`)), nil))
		...
		*gendung.LevelSpecialCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L1Data\L1S.CEL`)), nil))
	case gendung.Catacombs:
		*gendung.LevelCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L2Data\L2.CEL`)), nil))
		...
		*gendung.LevelSpecialCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L2Data\L2S.CEL`)), nil))
	case gendung.Caves:
		*gendung.LevelCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L3Data\L3.CEL`)), nil))
		...
		*gendung.LevelSpecialCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L1Data\L1S.CEL`)), nil))
	case gendung.Hell:
		*gendung.LevelCEL = (*uint8)(engine.MemLoadFile(unsafe.Pointer(C.CString(`Levels\L4Data\L4.CEL`)), nil))
