...
// checkL1Quest validates the implemenation of the dynamic random level
// generation of Cathedral maps, for dungeon level 2 with the Butcher quest
// active.
func checkL1Quest() error {
	...
	*multi.MaxPlayers = 1
	...
	if err := check(*gendung.TileIDMap, "tiles", seed, "659b95eec3e1c18d13b7f9932de108b88b356b9b"); err != nil {
		path := fmt.Sprintf("testdata_quest/l1_tiles_%08X.bin", seed)
		f, e := os.Open(path)
		if e != nil {
			return errors.WithStack(e)
		}
	...
	if err := check(*gendung.PieceIDMap, "pieces", seed, "15f2209ff5d066cfd568a1eab77e4328d08474e8"); err != nil {
		path := fmt.Sprintf("testdata_quest/l1_pieces_%08X.bin", seed)
		f, e := os.Open(path)
		if e != nil {
			return errors.WithStack(e)
		}
	...
	if err := check(*gendung.ArchNumMap, "arches", seed, "42941df3ada356ebf87ce2987d26a06c44da711a"); err != nil {
		path := fmt.Sprintf("testdata_quest/l1_arches_%08X.bin", seed)
		f, e := os.Open(path)
		if e != nil {
			return errors.WithStack(e)
		}
